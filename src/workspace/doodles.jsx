...
function Icon({ name, size = 22, color = INK, stroke = 1.8, style }) {
  ...
  const paths = {
    ...
    flower: <><circle cx="12" cy="13" r="2.1" {...p} /><circle cx="12" cy="8.4" r="2.5" {...p} /><circle cx="16.4" cy="11.6" r="2.5" {...p} /><circle cx="14.7" cy="16.8" r="2.5" {...p} /><circle cx="9.3" cy="16.8" r="2.5" {...p} /><circle cx="7.6" cy="11.6" r="2.5" {...p} /></>,
