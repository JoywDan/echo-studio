...
export default function BodyProtocolPage({ onClose }) {
  ...
  return <div className="body-protocol-page bp-v4-page">
    ...
    {state.phase !== 'protocol_reveal' && <div className="bp-play-layout">
