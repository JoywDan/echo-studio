...
function StudioCard({ mod, onClick }) {
  const studioStickers = {
    ...
    s3: [
      ...
      ["11_latte_cup", "studio-st cup diary"],
    ],
    s4: [
      ...
      ["pack_07", "studio-st candy"],
    ],
    s5: [
      ["12_ghost", "studio-st ghost-news"],
      ["10_music_notes", "studio-st music-news"],
      ["11_latte_cup", "studio-st cup news"],
      ["03_star", "studio-st star news"],
      ["pack_10", "studio-st worm"],
    ],
    s6: [
